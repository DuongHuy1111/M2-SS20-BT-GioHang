...
@section('content')
    ...
    <div class="login-container text-c animated flipInX">
        ...
        <h3 class="text-whitesmoke">Sign In Product Cart</h3>
        ...
        <div class="container-content">
            <form class="margin-t" action="{{route('products.loginAdmin')}}" method="post">
                @csrf
            ...
            <p class="margin-t text-whitesmoke"><small> Dương Huy &copy; 2019</small> </p>
        </div>
    </div>
    </body>
