...
@section('content')
    ...
    <div class="login-container text-c animated flipInX">
        ...
        <h3 class="text-whitesmoke">Create Product</h3>
        <div class="container-content">
            <form class="margin-t" action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <button type="submit" class="form-button button-l margin-b">Create</button>
                <button class="btn btn-secondary btn-sm" onclick="window.history.go(-1); return false;">Cancle</button>

            </form>
            <p class="margin-t text-whitesmoke"><small> Huy Alex &copy; 2019</small> </p>
        </div>
    </div>
    </body>
